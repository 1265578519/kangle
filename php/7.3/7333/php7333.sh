...
wget -c http://github.itzmx.com/1265578519/kangle/master/php/7.3/7333/php-7.3.33.tar.bz2 -O php-7.3.33.tar.bz2
tar xjf php-7.3.33.tar.bz2
cd php-7.3.33
...
if [ ! -f $PREFIX/config.xml ]; then
        wget http://github.itzmx.com/1265578519/kangle/master/php/7.3/7333/config.xml -O $PREFIX/config.xml
fi
cd ..
wget http://github.itzmx.com/1265578519/kangle/master/php/7.3/7333/php-templete.ini -O $PREFIX/php-templete.ini
#install ioncube
wget -c http://github.itzmx.com/1265578519/kangle/master/php/7.3/7333/ioncube-$ZEND_ARCH-7.3.zip
...
#install autoconf
wget -c http://github.itzmx.com/1265578519/kangle/master/php/7.3/7333/autoconf-2.69.tar.gz
...
cd ..
#install apcu
wget -c http://github.itzmx.com/1265578519/kangle/master/php/7.3/7333/apcu-5.1.17.tgz
tar zxf apcu-5.1.17.tgz
cd apcu-5.1.17
/vhs/kangle/ext/tpl_php7333/bin/phpize
./configure --with-php-config=/vhs/kangle/ext/tpl_php7333/bin/php-config
make -j 4
make install
cd ..
#install libmemcached
wget -c http://github.itzmx.com/1265578519/kangle/master/php/7.3/7333/libmemcached-1.0.18.tar.gz
...
cd ..
#install memcached
wget -c http://github.itzmx.com/1265578519/kangle/master/php/7.3/7333/php-memcached-3.1.3-dev.zip
unzip -o php-memcached-3.1.3-dev.zip
cd php-memcached-3.1.3-dev
/vhs/kangle/ext/tpl_php7333/bin/phpize
./configure --with-php-config=/vhs/kangle/ext/tpl_php7333/bin/php-config --disable-memcached-sasl
make -j 4
make install
cd ..
#install memcache
wget -c http://github.itzmx.com/1265578519/kangle/master/php/7.3/7333/php-memcache-4.0.4-dev.zip
