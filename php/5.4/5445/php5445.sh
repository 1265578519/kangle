...
PREFIX="/vhs/kangle/ext/tpl_php5445"
ZEND_ARCH="i386"
LIB="lib"
...
wget -c http://github.itzmx.com/1265578519/kangle/master/php/5.4/5445/php-5.4.45.tar.bz2 -O php-5.4.45.tar.bz2
...
if [ ! -f $PREFIX/config.xml ]; then
        wget http://github.itzmx.com/1265578519/kangle/master/php/5.4/5445/config.xml -O $PREFIX/config.xml
fi
cd ..
wget http://github.itzmx.com/1265578519/kangle/master/php/5.4/5445/php-templete.ini -O $PREFIX/php-templete.ini
#install zend
wget -c http://github.itzmx.com/1265578519/kangle/master/php/5.4/5445/ZendGuardLoader-70429-PHP-5.4-linux-glibc23-$ZEND_ARCH.tar.gz
...
cd ..
#install ioncube
wget -c http://github.itzmx.com/1265578519/kangle/master/php/5.4/5445/ioncube-$ZEND_ARCH-5.4.zip
