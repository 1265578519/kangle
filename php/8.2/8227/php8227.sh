...
wget -c http://github.itzmx.com/1265578519/kangle/master/php/8.2/8227/openssl-1.1.1k.tar.gz
...
/usr/bin/as --version
wget -c http://github.itzmx.com/1265578519/kangle/master/php/8.2/8227/libzip-1.3.2.tar.gz -O libzip-1.3.2.tar.gz
...
ldconfig -v
wget -c http://github.itzmx.com/1265578519/kangle/master/php/8.2/8227/sqlite-autoconf-3470200.tar.gz
...
ldconfig -v
wget -c http://github.itzmx.com/1265578519/kangle/master/php/8.2/8227/libxml2-2.9.0.tar.gz
...
ldconfig -v
wget -c http://github.itzmx.com/1265578519/kangle/master/php/8.2/8227/curl-7.76.0.tar.bz2
...
ldconfig -v
PREFIX="/vhs/kangle/ext/tpl_php8227"
ZEND_ARCH="i386"
LIB="lib"
...
wget -c http://github.itzmx.com/1265578519/kangle/master/php/8.2/8227/php-8.2.27.tar.bz2 -O php-8.2.27.tar.bz2
tar xjf php-8.2.27.tar.bz2
cd php-8.2.27
...
if [ ! -f $PREFIX/config.xml ]; then
        wget http://github.itzmx.com/1265578519/kangle/master/php/8.2/8227/config.xml -O $PREFIX/config.xml
fi
cd ..
wget http://github.itzmx.com/1265578519/kangle/master/php/8.2/8227/php-templete.ini -O $PREFIX/php-templete.ini
wget http://github.itzmx.com/1265578519/kangle/master/php/8.2/8227/cacert.pem -O $PREFIX/cacert.pem
#install ioncube
wget -c http://github.itzmx.com/1265578519/kangle/master/php/8.2/8227/ioncube-$ZEND_ARCH-8.2.zip
unzip ioncube-$ZEND_ARCH-8.2.zip
mkdir -p $PREFIX/ioncube
mv ioncube_loader_lin_8.2.so $PREFIX/ioncube/ioncube_loader_lin_8.2.so
#install autoconf
wget -c http://github.itzmx.com/1265578519/kangle/master/php/8.2/8227/autoconf-2.69.tar.gz
...
cd ..
#install apcu
wget -c http://github.itzmx.com/1265578519/kangle/master/php/8.2/8227/apcu-5.1.24.tgz
tar zxf apcu-5.1.24.tgz
cd apcu-5.1.24
/vhs/kangle/ext/tpl_php8227/bin/phpize
./configure --with-php-config=/vhs/kangle/ext/tpl_php8227/bin/php-config
make -j 4
make install
cd ..
#install libmemcached
wget -c http://github.itzmx.com/1265578519/kangle/master/php/8.2/8227/libmemcached-1.0.18.tar.gz
...
cd ..
#install memcached
wget -c http://github.itzmx.com/1265578519/kangle/master/php/8.2/8227/php-memcached-3.3.0.zip
unzip -o php-memcached-3.3.0.zip
cd php-memcached-3.3.0
/vhs/kangle/ext/tpl_php8227/bin/phpize
./configure --with-php-config=/vhs/kangle/ext/tpl_php8227/bin/php-config --disable-memcached-sasl
make -j 4
make install
cd ..
#install memcache
wget -c http://github.itzmx.com/1265578519/kangle/master/php/8.2/8227/pecl-memcache-8.2.zip
