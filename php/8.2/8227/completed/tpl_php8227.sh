...
wget http://github.itzmx.com/1265578519/kangle/master/php/8.2/8227/openssl-1.1.1k.tar.gz
...
wget -c http://github.itzmx.com/1265578519/kangle/master/php/8.2/8227/completed/tpl_php8227.tar.bz2 -O tpl_php8227.tar.bz2
tar xjf tpl_php8227.tar.bz2
mv tpl_php8227 $PREFIX
rm -rf /tmp/*
