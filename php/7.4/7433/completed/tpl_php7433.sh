...
wget -c http://github.itzmx.com/1265578519/kangle/master/php/7.4/7433/completed/tpl_php7433.tar.bz2 -O tpl_php7433.tar.bz2
tar xjf tpl_php7433.tar.bz2
mv tpl_php7433 $PREFIX
rm -rf /tmp/*
