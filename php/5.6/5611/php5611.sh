...
wget -c http://github.itzmx.com/1265578519/kangle/master/php/5.6/5611/php-5.6.11.tar.bz2 -O php-5.6.11.tar.bz2
...
if [ ! -f $PREFIX/config.xml ]; then
        wget http://github.itzmx.com/1265578519/kangle/master/php/5.6/5611/config.xml -O $PREFIX/config.xml
fi
cd ..
wget http://github.itzmx.com/1265578519/kangle/master/php/5.6/5611/php-templete.ini -O $PREFIX/php-templete.ini
#install ioncube
wget -c http://github.itzmx.com/1265578519/kangle/master/php/5.6/5611/ioncube-$ZEND_ARCH-5.6.zip
