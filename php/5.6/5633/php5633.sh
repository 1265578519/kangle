...
PREFIX="/vhs/kangle/ext/tpl_php5633"
ZEND_ARCH="i386"
LIB="lib"
...
wget -c http://github.itzmx.com/1265578519/kangle/master/php/5.6/5633/php-5.6.33.tar.bz2 -O php-5.6.33.tar.bz2
tar xjf php-5.6.33.tar.bz2
cd php-5.6.33
...
if [ ! -f $PREFIX/config.xml ]; then
        wget http://github.itzmx.com/1265578519/kangle/master/php/5.6/5633/config.xml -O $PREFIX/config.xml
fi
cd ..
wget http://github.itzmx.com/1265578519/kangle/master/php/5.6/5633/php-templete.ini -O $PREFIX/php-templete.ini
#install zend
wget -c http://github.itzmx.com/1265578519/kangle/master/php/5.6/5633/zend-loader-php5.6-linux-$ZEND_ARCH.tar.gz
...
cd ..
#install ioncube
wget -c http://github.itzmx.com/1265578519/kangle/master/php/5.6/5633/ioncube-$ZEND_ARCH-5.6.zip
...
cd ..
#install memcache
wget -c http://github.itzmx.com/1265578519/kangle/master/php/5.6/5633/memcache-3.0.8.tgz
