...
PREFIX="/vhs/kangle/ext/tpl_php5631"
ZEND_ARCH="i386"
LIB="lib"
...
wget -c http://github.itzmx.com/1265578519/kangle/master/php/5.6/5631/php-5.6.31.tar.bz2 -O php-5.6.31.tar.bz2
...
if [ ! -f $PREFIX/config.xml ]; then
        wget http://github.itzmx.com/1265578519/kangle/master/php/5.6/5631/config.xml -O $PREFIX/config.xml
fi
cd ..
wget http://github.itzmx.com/1265578519/kangle/master/php/5.6/5631/php-templete.ini -O $PREFIX/php-templete.ini
#install zend
wget -c http://github.itzmx.com/1265578519/kangle/master/php/5.6/5631/zend-loader-php5.6-linux-$ZEND_ARCH.tar.gz
...
#install ioncube
wget -c http://github.itzmx.com/1265578519/kangle/master/php/5.6/5631/ioncube-$ZEND_ARCH-5.6.zip
...
#install apcu
wget -c http://github.itzmx.com/1265578519/kangle/master/php/5.6/5631/apcu-4.0.10.tgz
tar zxf apcu-4.0.10.tgz
cd apcu-4.0.10
/vhs/kangle/ext/tpl_php5631/bin/phpize
./configure --with-php-config=/vhs/kangle/ext/tpl_php5631/bin/php-config
make -j 4
make install
#install memcache
wget -c http://github.itzmx.com/1265578519/kangle/master/php/5.6/5631/memcache-3.0.8.tgz
