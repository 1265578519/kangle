...
PREFIX="/vhs/kangle/ext/tpl_php5624"
ZEND_ARCH="i386"
LIB="lib"
...
wget -c http://github.itzmx.com/1265578519/kangle/master/php/5.6/5624/php-5.6.24.tar.bz2 -O php-5.6.24.tar.bz2
tar xjf php-5.6.24.tar.bz2
cd php-5.6.24
...
if [ ! -f $PREFIX/config.xml ]; then
        wget http://github.itzmx.com/1265578519/kangle/master/php/5.6/5624/config.xml -O $PREFIX/config.xml
fi
cd ..
wget http://github.itzmx.com/1265578519/kangle/master/php/5.6/5624/php-templete.ini -O $PREFIX/php-templete.ini
#install zend
wget -c http://github.itzmx.com/1265578519/kangle/master/php/5.6/5624/zend-loader-php5.6-linux-$ZEND_ARCH.tar.gz
...
#install ioncube
wget -c http://github.itzmx.com/1265578519/kangle/master/php/5.6/5624/ioncube-$ZEND_ARCH-5.6.zip
...
#install apcu
wget -c http://github.itzmx.com/1265578519/kangle/master/php/5.6/5624/apcu-4.0.10.tgz
tar zxf apcu-4.0.10.tgz
cd apcu-4.0.10
/vhs/kangle/ext/tpl_php5624/bin/phpize
./configure --with-php-config=/vhs/kangle/ext/tpl_php5624/bin/php-config
make -j 4
make install
#install memcache
wget -c http://github.itzmx.com/1265578519/kangle/master/php/5.6/5624/memcache-3.0.8.tgz
