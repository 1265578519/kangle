...
PREFIX="/vhs/kangle/ext/tpl_php7213"
ZEND_ARCH="i386"
LIB="lib"
...
wget -c http://github.itzmx.com/1265578519/kangle/master/php/7.2/7213/php-7.2.13.tar.bz2 -O php-7.2.13.tar.bz2
tar xjf php-7.2.13.tar.bz2
cd php-7.2.13
...
if [ ! -f $PREFIX/config.xml ]; then
        wget http://github.itzmx.com/1265578519/kangle/master/php/7.2/7213/config.xml -O $PREFIX/config.xml
fi
cd ..
wget http://github.itzmx.com/1265578519/kangle/master/php/7.2/7213/php-templete.ini -O $PREFIX/php-templete.ini
#install ioncube
wget -c http://github.itzmx.com/1265578519/kangle/master/php/7.2/7213/ioncube-$ZEND_ARCH-7.2.zip
...
#install apcu
wget -c http://github.itzmx.com/1265578519/kangle/master/php/7.2/7213/apcu-5.1.15.tgz
...
wget -c http://github.itzmx.com/1265578519/kangle/master/php/7.2/7213/libmemcached-1.0.18.tar.gz
...
cd ..
#install memcached
wget -c http://github.itzmx.com/1265578519/kangle/master/php/7.2/7213/php-memcached-3.1.0-dev.zip
unzip -o php-memcached-3.1.0-dev.zip
cd php-memcached-3.1.0-dev
/vhs/kangle/ext/tpl_php7213/bin/phpize
./configure --with-php-config=/vhs/kangle/ext/tpl_php7213/bin/php-config --disable-memcached-sasl
make -j 4
make install
cd ..
#install memcache
wget -c http://github.itzmx.com/1265578519/kangle/master/php/7.2/7213/php-memcache-3.0.9-dev.zip
