...
wget -c http://git.oschina.net/cc12655/kangle/raw/master/php/master/php/5.2/5217/php-5.2.17.tar.bz2 -O php-5.2.17.tar.bz2
...
if [ ! -f $PREFIX/config.xml ]; then
        wget http://git.oschina.net/cc12655/kangle/raw/master/php/master/php/5.2/5217/config.xml -O $PREFIX/config.xml
fi
cd ..
#install zend
wget -c http://git.oschina.net/cc12655/kangle/raw/master/php/master/php/5.2/5217/zend-3.3.9-$ZEND_ARCH.tar.bz2
tar xjf zend-3.3.9-$ZEND_ARCH.tar.bz2
mv zend-3.3.9-$ZEND_ARCH $PREFIX/zend
wget -c http://git.oschina.net/cc12655/kangle/raw/master/php/master/php/5.2/5217/zend.ini -O $PREFIX/etc/php.d/zend.ini

#install ioncube
wget -c http://git.oschina.net/cc12655/kangle/raw/master/php/master/php/5.2/5217/ioncube-$ZEND_ARCH-5.2.zip
...
wget -c http://git.oschina.net/cc12655/kangle/raw/master/php/master/php/5.2/5217/ioncube.ini -O $PREFIX/etc/php.d/ioncube.ini
rm -rf $PREFIX/php-templete.ini
wget http://git.oschina.net/cc12655/kangle/raw/master/php/master/php/5.2/5217/php-templete.ini -O $PREFIX/php-templete.ini
rm -rf /tmp/*
