...
PREFIX="/vhs/kangle/ext/tpl_php5527"
ZEND_ARCH="i386"
LIB="lib"
...
wget -c http://github.itzmx.com/1265578519/kangle/master/php/5.5/5527/php-5.5.27.tar.bz2 -O php-5.5.27.tar.bz2
...
if [ ! -f $PREFIX/config.xml ]; then
        wget http://github.itzmx.com/1265578519/kangle/master/php/5.5/5527/config.xml -O $PREFIX/config.xml
fi
cd ..
wget http://github.itzmx.com/1265578519/kangle/master/php/5.5/5527/php-templete.ini -O $PREFIX/php-templete.ini
#install ioncube
wget -c http://github.itzmx.com/1265578519/kangle/master/php/5.5/5527/ioncube-$ZEND_ARCH-5.5.zip
