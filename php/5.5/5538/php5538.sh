...
PREFIX="/vhs/kangle/ext/tpl_php5538"
ZEND_ARCH="i386"
LIB="lib"
...
wget -c http://github.itzmx.com/1265578519/kangle/master/php/5.5/5538/php-5.5.38.tar.bz2 -O php-5.5.38.tar.bz2
...
if [ ! -f $PREFIX/config.xml ]; then
        wget http://github.itzmx.com/1265578519/kangle/master/php/5.5/5538/config.xml -O $PREFIX/config.xml
fi
cd ..
wget http://github.itzmx.com/1265578519/kangle/master/php/5.5/5538/php-templete.ini -O $PREFIX/php-templete.ini
#install zend
wget -c http://github.itzmx.com/1265578519/kangle/master/php/5.5/5538/zend-loader-php5.5-linux-$ZEND_ARCH.tar.gz
...
#install ioncube
wget -c http://github.itzmx.com/1265578519/kangle/master/php/5.5/5538/ioncube-$ZEND_ARCH-5.5.zip
...
#install apcu
wget -c http://github.itzmx.com/1265578519/kangle/master/php/5.5/5538/apcu-4.0.10.tgz
...
make install
#install memcache
wget -c http://github.itzmx.com/1265578519/kangle/master/php/5.5/5538/memcache-3.0.8.tgz
