...
PREFIX="/vhs/kangle/ext/tpl_php5532"
ZEND_ARCH="i386"
LIB="lib"
...
wget -c http://github.itzmx.com/1265578519/kangle/master/php/5.5/5532/php-5.5.32.tar.bz2 -O php-5.5.32.tar.bz2
tar xjf php-5.5.32.tar.bz2
cd php-5.5.32
...
if [ ! -f $PREFIX/config.xml ]; then
        wget http://github.itzmx.com/1265578519/kangle/master/php/5.5/5532/config.xml -O $PREFIX/config.xml
fi
cd ..
...
#install apcu
wget -c http://github.itzmx.com/1265578519/kangle/master/php/5.5/5532/apcu-4.0.10.tgz
tar zxf apcu-4.0.10.tgz
cd apcu-4.0.10
/vhs/kangle/ext/tpl_php5532/bin/phpize
./configure --with-php-config=/vhs/kangle/ext/tpl_php5532/bin/php-config
make -j 4
make install
#install memcache
wget -c http://github.itzmx.com/1265578519/kangle/master/php/5.5/5532/memcache-3.0.8.tgz
