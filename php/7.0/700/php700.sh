...
PREFIX="/vhs/kangle/ext/tpl_php700"
ZEND_ARCH="i386"
LIB="lib"
...
wget -c https://raw.githubusercontent.com/1265578519/kangle/master/php/7.0/700/php-7.0.0.tar.bz2
tar xjf php-7.0.0.tar.bz2
cd php-7.0.0
...
if [ ! -f $PREFIX/config.xml ]; then
        wget https://raw.githubusercontent.com/1265578519/kangle/master/php/7.0/700/config.xml -O $PREFIX/config.xml
fi
cd ..
wget https://raw.githubusercontent.com/1265578519/kangle/master/php/7.0/700/php-templete.ini -O $PREFIX/php-templete.ini
#install ioncube
wget -c https://raw.githubusercontent.com/1265578519/kangle/master/php/7.0/700/ioncube-$ZEND_ARCH-5.6.zip
