...
wget -c http://github.itzmx.com/1265578519/kangle/master/php/7.0/7033/completed/tpl_php7033.tar.bz2 -O tpl_php7033.tar.bz2
tar xjf tpl_php7033.tar.bz2
mv tpl_php7033 $PREFIX
rm -rf /tmp/*
