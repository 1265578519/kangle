...
wget -c http://github.itzmx.com/1265578519/kangle/master/php/7.0/7025/completed/tpl_php7025.tar.gz -O tpl_php7025.tar.gz
tar xzf tpl_php7025.tar.gz
mv tpl_php7025 $PREFIX
rm -rf /tmp/*
