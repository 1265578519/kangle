...
PREFIX="/vhs/kangle/ext/tpl_php7025"
ZEND_ARCH="i386"
LIB="lib"
...
wget -c http://github.itzmx.com/1265578519/kangle/master/php/7.0/7025/php-7.0.25.tar.bz2 -O php-7.0.25.tar.bz2
tar xjf php-7.0.25.tar.bz2
cd php-7.0.25
...
if [ ! -f $PREFIX/config.xml ]; then
        wget http://github.itzmx.com/1265578519/kangle/master/php/7.0/7025/config.xml -O $PREFIX/config.xml
fi
cd ..
wget http://github.itzmx.com/1265578519/kangle/master/php/7.0/7025/php-templete.ini -O $PREFIX/php-templete.ini
#install ioncube
wget -c http://github.itzmx.com/1265578519/kangle/master/php/7.0/7025/ioncube-$ZEND_ARCH-7.0.zip
...
#install apcu
wget -c http://github.itzmx.com/1265578519/kangle/master/php/7.0/7025/apcu-5.1.3.tgz
tar zxf apcu-5.1.3.tgz
cd apcu-5.1.3
/vhs/kangle/ext/tpl_php7025/bin/phpize
./configure --with-php-config=/vhs/kangle/ext/tpl_php7025/bin/php-config
make -j 4
make install
cd ..
#install libmemcached
wget -c http://github.itzmx.com/1265578519/kangle/master/php/7.0/7025/libmemcached-1.0.18.tar.gz
...
cd ..
#install memcached
wget -c http://github.itzmx.com/1265578519/kangle/master/php/7.0/7025/php-memcached-php7.zip
unzip -o php-memcached-php7.zip
cd php-memcached-php7
/vhs/kangle/ext/tpl_php7025/bin/phpize
./configure --with-php-config=/vhs/kangle/ext/tpl_php7025/bin/php-config --disable-memcached-sasl
make -j 4
make install
cd ..
rm -rf /tmp/*
