...
wget -c http://github.itzmx.com/1265578519/kangle/master/php/7.1/718/php-7.1.8.tar.bz2 -O php-7.1.8.tar.bz2
...
if [ ! -f $PREFIX/config.xml ]; then
        wget http://github.itzmx.com/1265578519/kangle/master/php/7.1/718/config.xml -O $PREFIX/config.xml
fi
cd ..
wget http://github.itzmx.com/1265578519/kangle/master/php/7.1/718/php-templete.ini -O $PREFIX/php-templete.ini
#install ioncube
wget -c http://github.itzmx.com/1265578519/kangle/master/php/7.1/718/ioncube-$ZEND_ARCH-7.0.zip
...
#install apcu
wget -c http://github.itzmx.com/1265578519/kangle/master/php/7.1/718/apcu-5.1.3.tgz
