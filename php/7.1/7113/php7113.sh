...
if [ ! -f $PREFIX/config.xml ]; then
        wget http://github.itzmx.com/1265578519/kangle/master/php/7.1/7113/config.xml -O $PREFIX/config.xml
fi
cd ..
wget http://github.itzmx.com/1265578519/kangle/master/php/7.1/7113/php-templete.ini -O $PREFIX/php-templete.ini
#install ioncube
...
cd ..
#install memcached
wget -c http://github.itzmx.com/1265578519/kangle/master/php/7.1/7113/php-memcached-3.0.4.tar.gz
