...
wget -c http://github.itzmx.com/1265578519/kangle/master/php/7.1/7133/completed/tpl_php7133.tar.bz2 -O tpl_php7133.tar.bz2
tar xjf tpl_php7133.tar.bz2
mv tpl_php7133 $PREFIX
rm -rf /tmp/*
